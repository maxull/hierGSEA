...
## Step 4: control how many branches are shown
...
Below is a real hierarchy-aware Reactome example figure generated from the
bundled single-fiber workflow. The default branch cap is intentionally low so
the figure stays readable on a normal page rather than immediately turning into
a crowded ontology wall.
